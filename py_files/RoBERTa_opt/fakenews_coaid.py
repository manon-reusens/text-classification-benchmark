...
train_emo, val_emo, test_emo = data_splitter(data['CoAID'],0,create_val_set=True,test_split = 0.25, val_split = 0.2, seed=SEED)
...
name = 'fakenews_coaid_roberta' #change here
