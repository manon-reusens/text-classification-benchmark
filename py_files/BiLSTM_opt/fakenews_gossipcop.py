...
train_emo, val_emo, test_emo = data_splitter(data['gossipcop'],
                                 0, 
...
name = 'fakenews_gossipcop' #change here
...
def train(config=None):
    ...
    with wandb.init(config=config,project='bayes_lstm', group=name) as run:
       ...
       # artifact_dir=artifact.download()
        ...
        #make predictions
        accuracy, f1_score, aucpc, auc, a, b= bidir_lstm.make_predictions(model)
